 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Will Mitchell");
		  toPrint += p1.toString("wmitchell30");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Tommy McCormick");
		  toPrint += p2.toString("tmccormick30");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Amir Ghorbanian");
		  toPrint += p3.toString("aghorbanian3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Maddy Ben-Yoseph");
          toPrint += p4.toString("mby3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Andrey Lukin");
          toPrint += p5.toString("alukin3");
